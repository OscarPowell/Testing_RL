...
#     adv_env1 = cartpole_adv_pattanaikrandom_training(cartpole_env1, att_freq, Q) 
...
# ax.set_title('Average Reward During Training with QL on cart-pole Environment, Naive vs Pattanaik Attacks, Full Space')
# ax.legend() 
# plt.show()
...
# # adv_env1 = cartpole_adv_pattanaikrandom_training(cartpole_env1, att_freq, Q)
# # target_agent1 = cp.target_cartpole_agent(adv_env1)
# # target_agent1.train(algtype,alpha,gamma,epsilon,epsilon_decay_value,n)

# # target_agent1.set_env(cartpole_env1) #cut out the adversary to test its effect
# # results = target_agent1.test(30)
